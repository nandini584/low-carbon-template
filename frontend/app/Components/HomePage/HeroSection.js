...
const HeroSection = () => {
  return (
    <div className="bg-[#F4F4F4] md:pl-36 px-6 md:pr-96 md:py-20 py-4 flex flex-row items-center justify-between">
        <div>
            ...
            <ul className='text-lg text-black flex md:flex-row flex-col item-center justify-between md:mt-8 mt-6 w-[45vw] font-semibold'>
                <li><span className='md:text-2xl text-xl'>&#x1f4af;</span> Sustainability</li>
                <li><span className='md:text-2xl text-x'>&#x1f4af;</span> Accessibility</li>
                <li><span className='md:text-2xl text-x'>&#x1f4af;</span> SEO</li>
            </ul>
        </div>
      {/* <Image
